...
const Habits = () => {
  const [habits, setHabits] = useState([
    { icon: Moon, title: "Sleep 8 Hours", progress: 85, streak: 12, completed: true, partner1Progress: 90, partner2Progress: 80, color: "turquoise" as const },
    { icon: Brain, title: "Meditation", progress: 60, streak: 5, completed: false, partner1Progress: 70, partner2Progress: 50, color: "mint" as const },
    { icon: Droplets, title: "Drink Water", progress: 75, streak: 20, completed: true, partner1Progress: 80, partner2Progress: 70, color: "happiness" as const },
    { icon: BookOpen, title: "Read Together", progress: 40, streak: 3, completed: false, partner1Progress: 50, partner2Progress: 30, color: "accent" as const },
    { icon: Dumbbell, title: "Exercise", progress: 90, streak: 15, completed: true, partner1Progress: 95, partner2Progress: 85, color: "turquoise" as const },
    { icon: Apple, title: "Healthy Eating", progress: 55, streak: 7, completed: false, partner1Progress: 60, partner2Progress: 50, color: "mint" as const },
  ]);
    ...
    <div className="min-h-screen bg-background pb-24">
      <div className="max-w-lg mx-auto px-4 pt-6">
        ...
        <div className="flex items-center justify-between mb-6 opacity-0 animate-fade-in-up">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Your Shared Habits</h1>
        ...
        <AppCard variant="gradient" className="mb-4" delay={100}>
          <h3 className="text-base font-semibold text-foreground mb-4">Today's Progress</h3>
          
          <div className="grid grid-cols-4 gap-4">
            {[
              { icon: Moon, label: "Sleep", partner1: 90, partner2: 80 },
              { icon: Brain, label: "Mind", partner1: 70, partner2: 50 },
              { icon: Droplets, label: "Water", partner1: 80, partner2: 70 },
              { icon: BookOpen, label: "Learn", partner1: 50, partner2: 30 },
            ].map((item) => (
        ...
        <AppCard className="mb-4" delay={200}>
          <h3 className="text-base font-semibold text-foreground mb-4">Couple Completion</h3>
          ...
          <div className="mt-4 pt-4 border-t border-border">
            <div className="flex items-center justify-between">
              <span className="text-sm text-muted-foreground">Combined Average</span>
